...
function ($scope, $stateParams, $ionicModal,$ionicSlideBoxDelegate,$state,addressService) {
		...
		*/
        $scope.closeModalFrom = function () {
			var address={};
				...
				if($scope.fromaddress1!=address.address1)
				{
				$scope.fromaddress1="";
				$scope.fromaddress2="";
				$scope.fromcountry="";
		 ...
		 $scope.closeModalTo = function () {
				...
				if($scope.toaddress1!=address.address1)
				{
				$scope.toaddress1="";
				$scope.toaddress2="";
				$scope.tocountry="";
 ...
 .controller('rateListCtrl', ['$scope', '$stateParams','$http','$ionicLoading','addressService', // The following is the constructor function for this page's controller. See https://docs.angularjs.org/guide/controller
// You can include any angular dependencies as parameters for this function
// TIP: Access Route Parameters for your page via $stateParams.parameterName
function ($scope, $stateParams,$http,$ionicLoading,addressService) {
	fromaddress=addressService.getfromAddress();
	toaddress=addressService.gettoAddress();
	...
	template: '<ion-spinner icon="ripple"></ion-spinner>'
			  ...
			  $http.post("http://localhost:8080/fedex/rates",data)
